...
st.title("Background")
st.write('PcMag released an article of the [top 60 wfh](https://apple.news/AA6GPTj-UTEiMcpYbRDMKug) locations ([on gDocs](https://docs.google.com/document/d/1kzVOcWb-QCCeZkJyw8WEcWfJkllwU9j4PLBzQekR4to/edit)). This notebook is for visualizing that data in a more intuitive manner.')
